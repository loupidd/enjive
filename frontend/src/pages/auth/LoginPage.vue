<template>
  <div class="min-h-screen flex bg-surface-950 overflow-hidden relative">
    ...
    <!-- ── Left branding panel ───────────────────────────────── -->
    <div
      class="hidden lg:flex lg:w-[52%] flex-col justify-between p-14 relative z-10"
    >
      <!-- Logo -->
      <div class="flex items-center gap-3">
        <div
          class="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center shrink-0 p-1"
        >
          <img
        ...
        <div>
          ...
          <p
            class="text-caramel/50 text-[10px] uppercase tracking-[0.2em] font-semibold"
          >
            by TripleS
          </p>
        </div>
      ...
      <div class="space-y-6">
        <div>
          <h1
            class="text-5xl font-bold text-white leading-[1.1] tracking-tight hero-text"
          >
            Maintenance<br />
            <span class="text-caramel hero-highlight">Simplified.</span>
          </h1>
          <p class="text-denim-100/50 text-sm leading-relaxed mt-5 max-w-xs">
            Enterprise-grade facility management built for precision,
      ...
      <!-- Bottom tagline -->
      <p class="text-[11px] text-denim-200/25 tracking-wide">
        EnJive CMMS · Powered by TripleS
      </p>
    </div>
    ...
    <div class="flex-1 flex items-center justify-center p-8 relative z-10">
      <div class="w-full max-w-[360px] login-card-enter">
        ...
        <div class="flex items-center gap-3 mb-10 lg:hidden">
          <div
            class="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center shrink-0 p-0.5"
          >
            <img
              src="@/assets/enjive-mark.png"
              alt="EnJive"
          ...
          <div>
            ...
            <p class="text-caramel/60 text-[10px] uppercase tracking-widest">
              by TripleS
            </p>
          </div>
        </div>
        ...
        <!-- Form card -->
        <div
          class="bg-denim-800/70 border border-white/8 rounded-2xl p-8 backdrop-blur-xl shadow-2xl shadow-black/40"
        >
          <div class="mb-7">
            <h2 class="text-2xl font-bold text-white tracking-tight">
              Welcome back
            </h2>
            <p class="text-denim-200/50 text-sm mt-1">
              Sign in to your CMMS workspace
            </p>
          </div>
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <div class="relative">
                ...
                <div
                  ...
                  :class="form.email ? 'opacity-100' : 'opacity-0'"
                >
                  <svg
                    width="14"
                    height="14"
            ...
            <div
              class="form-field"
              :class="focused === 'password' ? 'focused' : ''"
            >
            ...
            <Transition name="error-fade">
              <div
                v-if="error"
                class="text-xs text-red-300 bg-red-500/10 border border-red-500/20 rounded-lg px-3 py-2.5 flex items-center gap-2"
              >
                <svg
                  width="12"
                  height="12"
            ...
            >
              <span
                v-if="loading"
                class="w-4 h-4 border-2 border-denim-900/30 border-t-denim-900 rounded-full animate-spin"
              />
              <span v-else>Sign in</span>
              <!-- Button shimmer sweep -->
              <span
                v-if="!loading"
                class="btn-shimmer absolute inset-0 pointer-events-none"
              />
            </button>
          </div>
        </div>
